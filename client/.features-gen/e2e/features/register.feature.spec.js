...
test.describe('User Registration', () => {
  ...
  test('Show error when terms not accepted', async ({ When, Then, And, page }) => { 
    await When('I enter "John Doe" in the name field', null, { page }); 
    await And('I enter "john@example.com" in the email field', null, { page }); 
    await And('I enter "password123" in the password field', null, { page }); 
    await And('I enter "password123" in the confirm password field', null, { page }); 
    await And('I click the submit button', null, { page }); 
    await Then('I should see "You must accept the Terms" error message', null, { page }); 
  });

  test('Successfully register a new user', async ({ Given, When, Then, And, page }) => { 
    await Given('the API will return a successful registration response', null, { page }); 
    await When('I enter "John Doe" in the name field', null, { page }); 
    await And('I enter "john@example.com" in the email field', null, { page }); 
    await And('I enter "password123" in the password field', null, { page }); 
    await And('I enter "password123" in the confirm password field', null, { page }); 
    await And('I check the terms checkbox', null, { page }); 
    await And('I click the submit button', null, { page }); 
    await Then('I should be redirected to the expenses page', null, { page }); 
  });

  test('Show error when email already exists', async ({ Given, When, Then, And, page }) => { 
    await Given('the API will return "User already exists with this email" error', null, { page }); 
    await When('I enter "John Doe" in the name field', null, { page }); 
    await And('I enter "existing@example.com" in the email field', null, { page }); 
    await And('I enter "password123" in the password field', null, { page }); 
    await And('I enter "password123" in the confirm password field', null, { page }); 
    await And('I check the terms checkbox', null, { page }); 
    await And('I click the submit button', null, { page }); 
    await Then('I should see "User already exists with this email" error message', null, { page }); 
  });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":60,"pickleLine":51,"tags":[],"steps":[{"pwStepLine":7,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"Given I am on the register page","isBg":true,"stepMatchArguments":[]},{"pwStepLine":61,"gherkinStepLine":52,"keywordType":"Action","textWithKeyword":"When I enter \"John Doe\" in the name field","stepMatchArguments":[{"group":{"start":8,"value":"\"John Doe\"","children":[{"start":9,"value":"John Doe","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":62,"gherkinStepLine":53,"keywordType":"Action","textWithKeyword":"And I enter \"john@example.com\" in the email field","stepMatchArguments":[{"group":{"start":8,"value":"\"john@example.com\"","children":[{"start":9,"value":"john@example.com","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":63,"gherkinStepLine":54,"keywordType":"Action","textWithKeyword":"And I enter \"password123\" in the password field","stepMatchArguments":[{"group":{"start":8,"value":"\"password123\"","children":[{"start":9,"value":"password123","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":64,"gherkinStepLine":55,"keywordType":"Action","textWithKeyword":"And I enter \"password123\" in the confirm password field","stepMatchArguments":[{"group":{"start":8,"value":"\"password123\"","children":[{"start":9,"value":"password123","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":65,"gherkinStepLine":56,"keywordType":"Action","textWithKeyword":"And I click the submit button","stepMatchArguments":[]},{"pwStepLine":66,"gherkinStepLine":57,"keywordType":"Outcome","textWithKeyword":"Then I should see \"You must accept the Terms\" error message","stepMatchArguments":[{"group":{"start":13,"value":"\"You must accept the Terms\"","children":[{"start":14,"value":"You must accept the Terms","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":69,"pickleLine":59,"tags":[],"steps":[{"pwStepLine":7,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"Given I am on the register page","isBg":true,"stepMatchArguments":[]},{"pwStepLine":70,"gherkinStepLine":60,"keywordType":"Context","textWithKeyword":"Given the API will return a successful registration response","stepMatchArguments":[]},{"pwStepLine":71,"gherkinStepLine":61,"keywordType":"Action","textWithKeyword":"When I enter \"John Doe\" in the name field","stepMatchArguments":[{"group":{"start":8,"value":"\"John Doe\"","children":[{"start":9,"value":"John Doe","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":72,"gherkinStepLine":62,"keywordType":"Action","textWithKeyword":"And I enter \"john@example.com\" in the email field","stepMatchArguments":[{"group":{"start":8,"value":"\"john@example.com\"","children":[{"start":9,"value":"john@example.com","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":73,"gherkinStepLine":63,"keywordType":"Action","textWithKeyword":"And I enter \"password123\" in the password field","stepMatchArguments":[{"group":{"start":8,"value":"\"password123\"","children":[{"start":9,"value":"password123","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":74,"gherkinStepLine":64,"keywordType":"Action","textWithKeyword":"And I enter \"password123\" in the confirm password field","stepMatchArguments":[{"group":{"start":8,"value":"\"password123\"","children":[{"start":9,"value":"password123","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":75,"gherkinStepLine":65,"keywordType":"Action","textWithKeyword":"And I check the terms checkbox","stepMatchArguments":[]},{"pwStepLine":76,"gherkinStepLine":66,"keywordType":"Action","textWithKeyword":"And I click the submit button","stepMatchArguments":[]},{"pwStepLine":77,"gherkinStepLine":67,"keywordType":"Outcome","textWithKeyword":"Then I should be redirected to the expenses page","stepMatchArguments":[]}]},
  {"pwTestLine":80,"pickleLine":69,"tags":[],"steps":[{"pwStepLine":7,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"Given I am on the register page","isBg":true,"stepMatchArguments":[]},{"pwStepLine":81,"gherkinStepLine":70,"keywordType":"Context","textWithKeyword":"Given the API will return \"User already exists with this email\" error","stepMatchArguments":[{"group":{"start":20,"value":"\"User already exists with this email\"","children":[{"start":21,"value":"User already exists with this email","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":82,"gherkinStepLine":71,"keywordType":"Action","textWithKeyword":"When I enter \"John Doe\" in the name field","stepMatchArguments":[{"group":{"start":8,"value":"\"John Doe\"","children":[{"start":9,"value":"John Doe","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":83,"gherkinStepLine":72,"keywordType":"Action","textWithKeyword":"And I enter \"existing@example.com\" in the email field","stepMatchArguments":[{"group":{"start":8,"value":"\"existing@example.com\"","children":[{"start":9,"value":"existing@example.com","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":84,"gherkinStepLine":73,"keywordType":"Action","textWithKeyword":"And I enter \"password123\" in the password field","stepMatchArguments":[{"group":{"start":8,"value":"\"password123\"","children":[{"start":9,"value":"password123","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":85,"gherkinStepLine":74,"keywordType":"Action","textWithKeyword":"And I enter \"password123\" in the confirm password field","stepMatchArguments":[{"group":{"start":8,"value":"\"password123\"","children":[{"start":9,"value":"password123","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":86,"gherkinStepLine":75,"keywordType":"Action","textWithKeyword":"And I check the terms checkbox","stepMatchArguments":[]},{"pwStepLine":87,"gherkinStepLine":76,"keywordType":"Action","textWithKeyword":"And I click the submit button","stepMatchArguments":[]},{"pwStepLine":88,"gherkinStepLine":77,"keywordType":"Outcome","textWithKeyword":"Then I should see \"User already exists with this email\" error message","stepMatchArguments":[{"group":{"start":13,"value":"\"User already exists with this email\"","children":[{"start":14,"value":"User already exists with this email","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
]; // bdd-data-end